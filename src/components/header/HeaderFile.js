...
import {
    ...
    ShoppingCartOutlined, ZoomInOutlined,
    ShoppingFilled, BorderOuterOutlined,
    SearchOutlined, GoogleOutlined,
    UserOutlined
                    ...
                    >
                        <Col span={24}>
                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly' }}>
                                ...
                                <span style={{ marginLeft: '10px', fontWeight: 'bold', fontSize: '15px' }}>
                                    <Tooltip placement="bottom" title={text} >
                                        {isAuthenticated ? (
                                            ...
                                            <Button {...btnProps} onClick={() => loginWithRedirect()}>Login</Button>
                                        )}
                                    </Tooltip>
                                </span>
                                <span style={{ marginLeft: '10px', fontWeight: 'bold', fontSize: '15px' }}>
                                ...
                                <span style={{ marginLeft: '10px', fontWeight: 'bold', fontSize: '15px' }} >
                                    <span onClick={showModal}><Avatar size="small" style={{ backgroundColor: '#87d068' }} icon={<UserOutlined />} />Profile</span>
                                </span>
